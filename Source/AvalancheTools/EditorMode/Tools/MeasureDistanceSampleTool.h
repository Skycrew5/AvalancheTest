 ...
 */
UCLASS()
class AVALANCHETOOLS_API UMeasureDistanceSampleToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class AVALANCHETOOLS_API UMeasureDistanceProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class AVALANCHETOOLS_API UMeasureDistanceSampleTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
