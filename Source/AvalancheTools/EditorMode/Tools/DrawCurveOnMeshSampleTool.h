 ...
 */
UCLASS(Transient)
class AVALANCHETOOLS_API UDrawCurveOnMeshSampleToolBuilder : public UMeshSurfacePointToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class AVALANCHETOOLS_API UDrawCurveOnMeshSampleToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS(Transient)
class AVALANCHETOOLS_API UDrawCurveOnMeshSampleTool : public UMeshSurfacePointTool
{
	GENERATED_BODY()
