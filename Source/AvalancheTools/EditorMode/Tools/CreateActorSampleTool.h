 ...
 */
UCLASS()
class AVALANCHETOOLS_API UCreateActorSampleToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class AVALANCHETOOLS_API UCreateActorSampleToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class AVALANCHETOOLS_API UCreateActorSampleTool : public USingleClickTool
{
	GENERATED_BODY()
